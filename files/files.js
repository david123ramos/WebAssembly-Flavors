...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'files/files.data';
  ...
  Module['FS_createPath']("/", "files", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_files/files.data');

      };
      Module['addRunDependency']('datafile_files/files.data');
   ...
   loadPackage({"files": [{"filename": "/files/test.txt", "start": 0, "end": 55, "audio": 0}], "remote_package_size": 55, "package_uuid": "c4b7007c-8df7-469a-b550-f2a6f043d079"});
